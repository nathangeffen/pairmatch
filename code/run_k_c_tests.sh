...
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 50 -s $RANDOM >output20k_C50.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 100 -s $RANDOM >output20k_C100.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 150 -s $RANDOM >output20k_C150.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 200 -s $RANDOM >output20k_C200.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 250 -s $RANDOM >output20k_C250.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 300 -s $RANDOM >output20k_C300.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 350 -s $RANDOM >output20k_C350.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 400 -s $RANDOM >output20k_C400.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 450 -s $RANDOM >output20k_C450.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 500 -s $RANDOM >output20k_C500.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 550 -s $RANDOM >output20k_C550.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 600 -s $RANDOM >output20k_C600.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 650 -s $RANDOM >output20k_C650.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 700 -s $RANDOM >output20k_C700.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 750 -s $RANDOM >output20k_C750.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 800 -s $RANDOM >output20k_C800.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 850 -s $RANDOM >output20k_C850.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 900 -s $RANDOM >output20k_C900.csv &
./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 950 -s $RANDOM >output20k_C950.csv &

wait # There are only 20 processors! Don't want the processes to contest for the CPUs.

./partnermatch -p 20000 -a C -r 40 -i 1 -n 200 -c 1000 -s $RANDOM >output20k_C1000.csv
